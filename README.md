...
**CONCH** is a distribution-free framework for offline changepoint localization that provides *exact finite-sample confidence sets*. This repository contains all simulation and real-data experiments from the [paper](https://arxiv.org/abs/2602.06267) .
